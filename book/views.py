...
class ExportView(TemplateView):
    template_name = 'book/export.html'
...
def export_book(request):
    ...
    writer.writerow(['ID', 'title', 'text', 'category', 'user'])

    books = Book.objects.all().values_list('id', 'title', 'text', 'category', 'user')
    for book in books:
...
def export_review(request):
    ...
    writer = csv.writer(response)
    writer.writerow(['ID', 'book', 'title', 'text', 'rate', 'user'])

    reviews = Review.objects.all().values_list('id', 'book', 'title', 'text', 'rate', 'user')
